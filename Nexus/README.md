...
- Launch a t3a.medium (Nexus needs 8 GB of RAM) EC2 instance using the Amazon Linux 2 AMI (ami-03c7d01cf4dedc891) with security group allowing `SSH (22), Nexus Port (8081), 8082 and 8083` connections.
...
ll
```
genellikle bir betik veya uygulamanın belirli bir kullanıcı kimliği (bu durumda "ec2-user") altında çalıştırılması gerektiğini belirtmek için kullanılır.
