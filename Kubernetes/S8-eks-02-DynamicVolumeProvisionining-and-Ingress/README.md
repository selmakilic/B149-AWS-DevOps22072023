...
- To use AWS EBS CSI, it is required to have an AWS Identity and Access Management (IAM) OpenID Connect (OIDC) provider for your cluster. 
  OpenID Connect, kimlik doğrulama için bir katman olarak OAuth 2.0 üzerine inşa edilmiş bir protokoldür.
...
iamserviceaccount cluster aws ytk ,service ulşm
rol ytk
...
metadata:
  ...
  annotations:
    nginx.ingress.kubernetes.io/rewrite-target: /    #trf ynl pt
spec:
