...
DROP DATABASE ms; -- Silme işleminin yapılabilmesi için Database' den Disconnect yapılması gerekmektedir.
...
-- Komutları çok seçerekde Execute edebilirsiniz. Bunun için ; kullanılması gerekmektedir.
