...
### STEP 3: Create Static WebSite Hosting :
 ...
 1. Create Static WebSite Hosting-1/ "www.[your domain name].net"
  ...
  - Bucket name : www.techprodevops.com
  - Public Access:  "Enabled"
  - creat bucket
  - Upload Files named "index.html" and "sorry.jpg" in "s3.bucket.www" folder
  properties >> Static website hosting >>edit >> Enable >> index.html >> save changes
...
- select "www.[your DNS name].net" A-record ---> Edit
	www.techprodevops.com >>tkl >>edit record >> value >> IP of N.Virginia_2   ekl
```bash
Name:"www"
Value/Route traffic to:
...
nslookup www.techprodevops.com
mobile delere
...
- After show "www.techprodevops.com" on the browser. It will reflects the "www.techprodevops.com". After that >>> "Delete"  this record 
cname delete
www.techprodevops.com delete
